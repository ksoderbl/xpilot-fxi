/* $Id: keys.h,v 1.4 2008/08/15 15:09:52 rotunda_pk Exp $
 *
...
typedef enum {
	...
	NUM_CLIENT_KEYS
/* The number of keys really used by the client. */
#endif
} keys_t;
...
extern int8_t* Get_keyHelpString(keys_t key);
extern const int8_t *Get_keyResourceString(keys_t key);
